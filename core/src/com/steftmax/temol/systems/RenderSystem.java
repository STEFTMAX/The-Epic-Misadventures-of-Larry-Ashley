...
public class RenderSystem extends IteratingSystem implements ResolutionListener {
	...
	public void resize(int width, int height) {
		...
		System.out.println(width % scale== 0 ? "true" : "untrue");//TODO force same thingy you know what to
	}
...
//		final int standardHeight = 480;
//
//		final int widthScale = (int) Math.ceil((float) width / standardWidth);
//		final int heightScale = (int) Math.ceil((float) height / standardHeight);
